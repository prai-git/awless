...
var awsResourcesDef = map[string]map[string]*propertyTransform{
	...
	cloud.Instance: {
		...
		properties.SecurityGroups:    {name: "SecurityGroups", transform: extractSliceValues("GroupId")},
		...
		properties.NetworkInterfaces: {name: "NetworkInterfaces", transform: extractSliceValues("NetworkInterfaceId")},
	...
	cloud.Keypair: {
		properties.Name:        {name: "KeyName", transform: extractValueFn},
	...
	cloud.InternetGateway: {
		properties.Name: {name: "Tags", transform: extractTagFn("Name")},
		properties.Vpcs: {name: "Attachments", transform: extractSliceValues("VpcId")},
	},
	cloud.RouteTable: {
		properties.Name:   {name: "Tags", transform: extractTagFn("Name")},
		properties.Vpc:    {name: "VpcId", transform: extractValueFn},
	...
	cloud.AvailabilityZone: {
		...
		properties.Messages: {name: "Messages", transform: extractSliceValues("Message")},
	},
	// LoadBalancer
	cloud.LoadBalancer: {
		properties.Name:              {name: "LoadBalancerName", transform: extractValueFn},
		properties.AvailabilityZones: {name: "AvailabilityZones", transform: extractSliceValues("ZoneName")},
		properties.Subnets:           {name: "AvailabilityZones", transform: extractSliceValues("SubnetId")},
	...
	cloud.Listener: {
		properties.Certificates: {name: "Certificates", transform: extractSliceValues("CertificateArn")},
		properties.Actions:      {name: "DefaultActions", transform: extractSliceValues("Type")},
	...
	cloud.Database: {
		...
		properties.ParameterGroups:           {name: "DBParameterGroups", transform: extractSliceValues("DBParameterGroupName")},
		properties.DBSecurityGroups:          {name: "DBSecurityGroups", transform: extractSliceValues("DBSecurityGroupName")},
		...
		properties.OptionGroups:              {name: "OptionGroupMemberships", transform: extractSliceValues("OptionGroupName")},
		...
		properties.SecurityGroups:            {name: "VpcSecurityGroups", transform: extractSliceValues("VpcSecurityGroupId")},
	},
	cloud.DbSubnetGroup: {
		...
		properties.Subnets:     {name: "Subnets", transform: extractSliceValues("SubnetIdentifier")},
		properties.Vpc:         {name: "VpcId", transform: extractValueFn},
	},
	//IAM
	cloud.User: {
		...
		properties.InlinePolicies:   {name: "UserPolicyList", transform: extractSliceValues("PolicyName")},
	},
	cloud.Role: {
		...
		properties.Created:        {name: "CreateDate", transform: extractTimeFn},
		properties.Path:           {name: "Path", transform: extractValueFn},
		properties.InlinePolicies: {name: "RolePolicyList", transform: extractSliceValues("PolicyName")},
	},
	cloud.Group: {
		properties.Name:           {name: "GroupName", transform: extractValueFn},
		properties.Arn:            {name: "Arn", transform: extractValueFn},
		properties.Created:        {name: "CreateDate", transform: extractTimeFn},
		properties.Path:           {name: "Path", transform: extractValueFn},
		properties.InlinePolicies: {name: "GroupPolicyList", transform: extractSliceValues("PolicyName")},
	},
	cloud.Policy: {
	...
	cloud.Record: {
		...
		properties.Records:               {name: "ResourceRecords", transform: extractSliceValues("Value")},
